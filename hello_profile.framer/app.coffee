# This imports all the layers for "hello_profile" into hello_profileLayers
sketch = Framer.Importer.load "imported/hello_profile"
...
##AB_basic기본 레이어정의
AB_basic.width = Screen.width
AB_basic.height = Screen.height
basic_bg = new Layer
	width : screen.widht, height : screen.height
...
## onload 최초 위치 잡기
AB_top_layers.visible = true
AB_top_layers.y = 72
AB_main.visible = true
AB_main.y = 72
AB_profile.visible = true
AB_profile.y = 1920
