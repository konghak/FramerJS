exports.cardtype = (superL, startScroll) ->
    ...
    for i in [0...8]
        layer = new Layer 
            ...
            width: scroll.width - 80, height: height 
            x: 40, y: (height + margin) * i 
            image : "images/tagcard_0"+i+".png"
            superLayer: scroll.content
        # layer.centerX(0)
        
        layer.style = "font-size":"48px", "font-weight":"300", "color":"#333", "lineHeight":"#{height}px", "box-shadow":"0 1px 6px rgba(0,0,0,0.2)", "backgroundColor" : "white"
