...
},{"./Animators/BezierCurveAnimator":5,"./Animators/LinearAnimator":6,"./Animators/SpringDHOAnimator":7,"./Animators/SpringRK4Animator":8,"./Config":15,"./Defaults":18,"./EventEmitter":21,"./Underscore":43,"./Utils":44}],2:[function(require,module,exports){
...
},{"./EventEmitter":21,"./Underscore":43}],3:[function(require,module,exports){
...
},{"./Config":15,"./EventEmitter":21,"./Underscore":43,"./Utils":44}],4:[function(require,module,exports){
var Config, Utils;
...
},{"./Config":15,"./Utils":44}],5:[function(require,module,exports){
...
},{"../Animator":4,"../Underscore":43,"../Utils":44}],6:[function(require,module,exports){
var Animator, Utils,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../Animator":4,"../Utils":44}],7:[function(require,module,exports){
var Animator, Utils,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../Animator":4,"../Utils":44}],8:[function(require,module,exports){
...
},{"../Animator":4,"../Integrator":29,"../Utils":44}],9:[function(require,module,exports){
var Layer,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"./Layer":30}],10:[function(require,module,exports){
...
exports.BaseClass = (function(superClass) {
  ...
  BaseClass.define = function(propertyName, descriptor) {
    ...
    if (!descriptor.set) {
      descriptor.set = function() {
        throw Error(this.constructor.name + "." + propertyName + " property is readonly");
      };
    }
  ...
  BaseClass.proxyProperty = function(keyPath, exportable) {
  ...
  BaseClass.define("props", {
    get: function() {
      var k, props, ref, v;
      props = {};
      ref = this.constructor[DefinedPropertiesKey];
      for (k in ref) {
        v = ref[k];
...
},{"./EventEmitter":21,"./Underscore":43,"./Utils":44}],11:[function(require,module,exports){
...
},{"./BaseClass":10,"./Events":23}],12:[function(require,module,exports){
...
exports.PageComponent = (function(superClass) {
  ...
  PageComponent.define("originX", PageComponent.simpleProperty("originX", .5, true));

  PageComponent.define("originY", PageComponent.simpleProperty("originY", .5, true));

  PageComponent.define("velocityThreshold", PageComponent.simpleProperty("velocityThreshold", 0.1, true));
  ...
  function PageComponent() {
    ...
    this.content.on("change:frame", _.debounce(this._scrollMove, 1));
    this._content.on("change:subLayers", (function(_this) {
      return function() {
        return _this._currentLayer = _this.closestLayer();
      };
    })(this));
    this._currentLayer = null;
  }

  PageComponent.prototype.closestLayer = function() {
  ...
  PageComponent.prototype.nextPage = function(direction, currentPage) {
    ...
    if (direction === "up") {
      layers = this.contentLayersAbove(point);
    }
    if (direction === "right") {
      layers = this.contentLayersRight(point);
    }
    if (direction === "bottom") {
      layers = this.contentLayersBottom(point);
    }
    if (direction === "left") {
      layers = this.contentLayersLeft(point);
    }
  ...
  PageComponent.prototype.snapToNextPage = function(direction, animate, animationOptions) {
    ...
    if (!nextPage) {
      return this.scrollToClosestLayer(this.originX, this.originY, true, animationOptions);
    } else {
      return this.scrollToLayer(nextPage, this.originX, this.originY, true, animationOptions);
    }
  };
  ...
  PageComponent.prototype._scrollMove = function() {
    var currentPage, ref;
    currentPage = this.currentPage;
    if ((ref = this._lastCurrentPage) !== currentPage && ref !== null) {
      this.emit("change:currentPage", {
        old: this._lastCurrentPage,
        "new": currentPage
      });
    }
    return this._lastCurrentPage = currentPage;
  };

  PageComponent.prototype._scrollEnd = function() {
    var layer, velocity;
    if (!this.content.draggable.isDragging) {
      return;
    }
    velocity = this.content.draggable.velocity;
    if (Math.max(Math.abs(velocity.x), Math.abs(velocity.y)) < this.velocityThreshold) {
      this.scrollToClosestLayer(this.originX, this.originY, true, this.animationOptions);
    }
    layer = this.nextPage(this.content.draggable.direction, this._currentPage);
    if (!layer) {
      return this.scrollToClosestLayer(this.originX, this.originY, true, this.animationOptions);
    } else {
      return this.scrollToLayer(layer, this.originX, this.originY, true, this.animationOptions);
    }
  };
...
},{"../Events":23,"./ScrollComponent":13}],13:[function(require,module,exports){
...
exports.ScrollComponent = (function(superClass) {
  ...
  ScrollComponent.define("velocity", ScrollComponent.proxyProperty("content.draggable.velocity", true));

  ScrollComponent.define("angle", ScrollComponent.proxyProperty("content.draggable.angle", true));

  ScrollComponent.define("scrollHorizontal", ScrollComponent.proxyProperty("content.draggable.horizontal", true));

  ScrollComponent.define("scrollVertical", ScrollComponent.proxyProperty("content.draggable.vertical", true));

  ScrollComponent.define("speedX", ScrollComponent.proxyProperty("content.draggable.speedX", true));

  ScrollComponent.define("speedY", ScrollComponent.proxyProperty("content.draggable.speedY", true));

  ScrollComponent.define("isDragging", ScrollComponent.proxyProperty("content.draggable.isDragging", true));

  ScrollComponent.define("draggable", {
    get: function() {
      throw Error("You likely want to use content.draggable");
    }
  });
  ...
  ScrollComponent.define("mouseWheelSpeedMultiplier", ScrollComponent.simpleProperty("mouseWheelSpeedMultiplier", 1, true, _.isNumber));
  ...
  function ScrollComponent(options) {
    ...
    this._updateContent = bind(this._updateContent, this);
    ...
    ref = ["contentInset", "scrollPoint", "scrollX", "scrollY", "scrollFrame", "mouseWheelEnabled"];
    ...
    this._contentInset = Utils.zeroRect();
    this.setContentLayer(new Layer);
    this._enableMouseWheelHandling();
  }

  ScrollComponent.prototype.calculateContentSize = function() {
  ...
  ScrollComponent.prototype.setContentLayer = function(layer) {
    ...
    this._content.on("change:subLayers", this._updateContent);
    this.on("change:width", this._updateContent);
    this.on("change:height", this._updateContent);
    this._updateContent();
    this.scrollPoint = {
      x: 0,
      y: 0
  ...
  ScrollComponent.prototype._updateContent = function() {
    var constraintsFrame, contentFrame;
    contentFrame = this.calculateContentSize();
    contentFrame.x = 0 + this._contentInset.left;
    contentFrame.y = 0 + this._contentInset.top;
    this.content.frame = contentFrame;
    constraintsFrame = this.calculateContentSize();
    constraintsFrame = {
    ...
    if (animate) {
      return _.defer((function(_this) {
        return function() {
          ...
          _this.content.animateStop();
          return _this.content.animate(animationOptions);
        };
      })(this));
    } else {
  ...
  ScrollComponent.prototype.scrollToLayer = function(contentLayer, originX, originY, animate, animationOptions) {
    ...
    if (contentLayer.superLayer !== this.content) {
  ...
  ScrollComponent.prototype.contentLayersAbove = function(point) {
    return _.filter(this.content.subLayers, (function(_this) {
      return function(l) {
        return Utils.framePointForOrigin(l.frame, _this.originX, _this.originY).y > point.y;
      };
    })(this));
  };

  ScrollComponent.prototype.contentLayersBelow = function(point) {
    return _.filter(this.content.subLayers, (function(_this) {
      return function(l) {
        return Utils.framePointForOrigin(l.frame, _this.originX, _this.originY).y < point.y;
      };
  ...
  ScrollComponent.prototype.contentLayersLeft = function(point) {
    return _.filter(this.content.subLayers, (function(_this) {
      return function(l) {
        return Utils.framePointForOrigin(l.frame, _this.originX, _this.originY).x < point.x;
      };
    })(this));
  };

  ScrollComponent.prototype.contentLayersRight = function(point) {
    return _.filter(this.content.subLayers, (function(_this) {
      return function(l) {
        return Utils.framePointForOrigin(l.frame, _this.originX, _this.originY).x > point.x;
      };
...
},{"../Events":23,"../Layer":30,"../Underscore":43,"../Utils":44}],14:[function(require,module,exports){
  ...
  function SliderComponent(options) {
    ...
    this.on("mousedown", (function(_this) {
      return function(event) {
        _this.value = _this.valueForPoint(event.x - _this.screenFrame.x);
        return _this.knob.draggable._touchStart(event);
      };
    })(this));
...
},{"../Events":23,"../Layer":30,"../Utils":44}],15:[function(require,module,exports){
var FramerCSS, Utils;
...
},{"./Utils":44}],16:[function(require,module,exports){
...
exports.Context = (function(superClass) {
  ...
  Context.prototype.reset = function() {
    var animation, i, len, ref, ref1, ref2, ref3, ref4, ref5;
    if ((ref = this.eventManager) != null) {
      ref.reset();
    }
    this.eventManager = new EventManager;
    if ((ref1 = this._rootElement) != null) {
      if ((ref2 = ref1.parentNode) != null) {
        if (typeof ref2.removeChild === "function") {
          ref2.removeChild(this._rootElement);
        }
      }
    }
    this._rootElement = this._createRootElement();
    if ((ref3 = this._delayTimers) != null) {
      ref3.map(function(timer) {
        return window.clearTimeout(timer);
      });
    }
    if ((ref4 = this._delayIntervals) != null) {
      ref4.map(function(timer) {
        return window.clearInterval(timer);
      });
    }
    if (this._animationList) {
      ref5 = this._animationList;
...
},{"./BaseClass":10,"./Config":15,"./EventManager":22,"./Underscore":43,"./Utils":44}],17:[function(require,module,exports){
...
},{"./Context":16,"./Utils":44}],18:[function(require,module,exports){
...
},{"./Underscore":43,"./Utils":44}],19:[function(require,module,exports){
var AppleWatch38Device, AppleWatch42Device, BaseClass, Defaults, DeviceViewDefaultDevice, Devices, Events, Layer, Nexus5BaseDevice, Nexus5BaseDeviceHand, Utils, _, iPadAirBaseDevice, iPadAirBaseDeviceHand, iPadMiniBaseDevice, iPadMiniBaseDeviceHand, iPhone5BaseDevice, iPhone5BaseDeviceHand, iPhone5CBaseDevice, iPhone5CBaseDeviceHand, iPhone6BaseDevice, iPhone6BaseDeviceHand, iPhone6PlusBaseDevice, iPhone6PlusBaseDeviceHand,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
exports.DeviceView = (function(superClass) {
  ...
  DeviceView.prototype._setup = function() {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      layer = ref[i];
      results.push(layer.on("touchmove", function(event) {
...
},{"./BaseClass":10,"./Defaults":18,"./Events":23,"./Layer":30,"./Underscore":43,"./Utils":44}],20:[function(require,module,exports){
...
},{"./BaseClass":10,"./Events":23,"./Underscore":43,"./Utils":44}],21:[function(require,module,exports){
var EventEmitter;
...
},{"eventemitter3":46}],22:[function(require,module,exports){
...
},{"./Underscore":43,"./Utils":44}],24:[function(require,module,exports){
...
},{"./MobileScrollFix":25,"./OmitNew":26}],25:[function(require,module,exports){
var Utils,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"./Animation":1,"./AnimationGroup":2,"./AnimationLoop":3,"./Animators/BezierCurveAnimator":5,"./Animators/LinearAnimator":6,"./Animators/SpringDHOAnimator":7,"./Animators/SpringRK4Animator":8,"./BackgroundLayer":9,"./BaseClass":10,"./Canvas":11,"./Components/PageComponent":12,"./Components/ScrollComponent":13,"./Components/SliderComponent":14,"./Config":15,"./Context":16,"./Debug":17,"./Defaults":18,"./DeviceView":19,"./EventEmitter":21,"./Events":23,"./Extras/Extras":24,"./Importer":28,"./Layer":30,"./LayerDraggable":32,"./LayerStyle":34,"./Print":35,"./Screen":37,"./Underscore":43,"./Utils":44,"./VideoLayer":45}],28:[function(require,module,exports){
...
},{"./Underscore":43,"./Utils":44}],29:[function(require,module,exports){
var Config, Utils;
...
},{"./Config":15,"./Utils":44}],30:[function(require,module,exports){
var Animation, BaseClass, Config, Defaults, EventEmitter, LayerAnchor, LayerDraggable, LayerStates, LayerStyle, Utils, _, layerProperty, layerValueTypeError,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty,
  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
...
LayerAnchor = require("./LayerAnchor").LayerAnchor;
  ...
  return result = {
    ...
    set: function(value) {
      ...
      if (name === "x" || name === "y" || name === "width" || name === "height") {
        return this.emit("change:frame", value);
      }
    }
  };
};
...
exports.Layer = (function(superClass) {
  ...
  function Layer(options) {
    ...
    ref = ["minX", "midX", "maxX", "minY", "midY", "maxY"];
    for (i = 0, len = ref.length; i < len; i++) {
      k = ref[i];
      if (options.hasOwnProperty(k)) {
        this[k] = options[k];
  ...
  Layer.define("siblingLayers", {
    ...
    get: function() {
      if (this.superLayer === null) {
        return _.filter(this._context._layerList, (function(_this) {
  ...
  Layer.prototype.anchor = function() {
    var ref;
    if (!this._anchor) {
      return this._anchor = (function(func, args, ctor) {
        ctor.prototype = func.prototype;
        var child = new ctor, result = func.apply(child, args);
        return Object(result) === result ? result : child;
      })(LayerAnchor, [this].concat(slice.call(arguments)), function(){});
    } else {
      return (ref = this._anchor).updateRules.apply(ref, arguments);
    }
  };
...
},{"./Animation":1,"./BaseClass":10,"./Config":15,"./Defaults":18,"./EventEmitter":21,"./LayerAnchor":31,"./LayerDraggable":32,"./LayerStates":33,"./LayerStyle":34,"./Underscore":43,"./Utils":44}],31:[function(require,module,exports){
...
},{"./EventEmitter":21}],32:[function(require,module,exports){
var BaseClass, Defaults, EventBuffer, Events, PanRecognizer, Simulation, Utils, _,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
PanRecognizer = require("./Recognizers/PanRecognizer").PanRecognizer;
...
exports.LayerDraggable = (function(superClass) {
  ...
  LayerDraggable.define("speedX", LayerDraggable.simpleProperty("speedX", 1, true));

  LayerDraggable.define("speedY", LayerDraggable.simpleProperty("speedY", 1, true));

  LayerDraggable.define("horizontal", LayerDraggable.simpleProperty("horizontal", true, true));

  LayerDraggable.define("vertical", LayerDraggable.simpleProperty("vertical", true, true));

  LayerDraggable.define("momentumVelocityMultiplier", LayerDraggable.simpleProperty("momentumVelocityMultiplier", 800, true, _.isNumber));

  LayerDraggable.define("propagateEvents", LayerDraggable.simpleProperty("propagateEvents", true, true, _.isBool));
  ...
  function LayerDraggable(layer) {
    ...
    _.extend(this, Defaults.getDefaults("LayerDraggable", {}));
    LayerDraggable.__super__.constructor.apply(this, arguments);
    this.enabled = true;
  ...
  LayerDraggable.prototype._touchStart = function(event) {
    ...
    this._layerStartPoint = {
      x: this.layer.x,
      y: this.layer.y
    };
    if (this.constraints && this.bounce) {
      this._layerStartPoint = this._constrainPosition(this._layerStartPoint, this.constraints, 1 / this.overdragScale);
    }
    ...
    this._layerCursorOffset = {
      x: touchEvent.clientX - this._layerStartPoint.x,
      y: touchEvent.clientY - this._layerStartPoint.y
    };
    this._screenScale = {
  ...
  LayerDraggable.prototype._touchMove = function(event) {
    var correctedDelta, delta, point, touchEvent;
    if (!this.enabled) {
      return;
    }
    event.preventDefault();
    ...
    delta = {
      x: touchEvent.clientX - this._cursorStartPoint.x,
      y: touchEvent.clientY - this._cursorStartPoint.y
    };
    correctedDelta = {
      x: delta.x * this.speedX * (1 / this._screenScale.x) * this.layer.scaleX * this.layer.scale,
      y: delta.y * this.speedY * (1 / this._screenScale.y) * this.layer.scaleY * this.layer.scale,
      t: Date.now()
    };
    point = {
      x: this.layer.x,
    ...
    if (this.horizontal) {
      point.x = this._cursorStartPoint.x + correctedDelta.x - this._layerCursorOffset.x;
    }
    if (this.vertical) {
      point.y = this._cursorStartPoint.y + correctedDelta.y - this._layerCursorOffset.y;
    }
    if (this.lockDirection) {
      if (!this._lockDirectionEnabledX && !this._lockDirectionEnabledY) {
        this._updateLockDirection(correctedDelta);
        return;
      } else {
        if (this._lockDirectionEnabledX) {
          point.x = this._layerStartPoint.x;
        }
        if (this._lockDirectionEnabledY) {
          point.y = this._layerStartPoint.y;
        }
      }
    }
    if (this._constraints) {
      point = this._constrainPosition(point, this._constraints);
    }
    if (this.pixelAlign) {
  ...
  LayerDraggable.prototype._constrainPosition = function(proposedPoint, bounds, scale) {
    ...
    if (this.overdrag) {
      point = {
        x: this._clampAndScale(proposedPoint.x, minX, maxX, this.overdragScale),
        y: this._clampAndScale(proposedPoint.y, minY, maxY, this.overdragScale)
      };
    } else {
      point = {
  ...
  LayerDraggable.prototype._calculateSimulationVelocity = function() {
    ...
    if (!xFinished) {
      velocity.x = this._simulation.x.simulator.state.v / this.velocityScale;
    }
    if (!yFinished) {
      velocity.y = this._simulation.y.simulator.state.v / this.velocityScale;
    }
    return velocity;
  };
  ...
  LayerDraggable.prototype._updateLockDirection = function(correctedDelta) {
    var xSlightlyPreferred, ySlightlyPreferred;
    this._lockDirectionEnabledX = Math.abs(correctedDelta.y) > this.lockDirectionThreshold.y;
    this._lockDirectionEnabledY = Math.abs(correctedDelta.x) > this.lockDirectionThreshold.x;
    xSlightlyPreferred = Math.abs(correctedDelta.y) > this.lockDirectionThreshold.y / 2;
    ySlightlyPreferred = Math.abs(correctedDelta.x) > this.lockDirectionThreshold.x / 2;
    if (xSlightlyPreferred && ySlightlyPreferred) {
      this._lockDirectionEnabledX = this._lockDirectionEnabledY = true;
    }
    if (this._lockDirectionEnabledX || this._lockDirectionEnabledY) {
      return this.emit(Events.DirectionLock, {
        x: this._lockDirectionEnabledX,
        y: this._lockDirectionEnabledY
      });
    }
  };

  LayerDraggable.prototype._resetLockDirection = function() {
    this._lockDirectionEnabledX = false;
    return this._lockDirectionEnabledY = false;
  };
  ...
  LayerDraggable.prototype._onSimulationStep = function(axis, state) {
    ...
    if (axis === "x" && (this._lockDirectionEnabledX || this.horizontal === false)) {
      return;
    }
    if (axis === "y" && (this._lockDirectionEnabledY || this.vertical === false)) {
      return;
    }
    if (this.constraints) {
      if (this.bounce) {
    ...
    this.emit(Events.DragWillMove, {
      animation: true
    });
    this.layer[axis] = this.updatePosition(updatePoint)[axis];
    this.emit(Events.DragMove, {
      animation: true
    });
    return this.emit(Events.DragDidMove, {
      animation: true
    });
  };

  LayerDraggable.prototype._onSimulationStop = function(axis, state) {
    this.emit(Events.DidEndAnimation, {
      axis: axis
    });
    if (this.pixelAlign) {
  ...
  LayerDraggable.prototype._startSimulation = function() {
    var maxX, maxY, minX, minY, ref, startSimulationX, startSimulationY, velocity;
    ...
    this._simulation.x.simulator.setState({
      x: this.layer.x,
      v: velocity.x * this.momentumVelocityMultiplier * this.speedX
    });
    if (startSimulationX) {
    ...
    this._simulation.y.simulator.setState({
      x: this.layer.y,
      v: velocity.y * this.momentumVelocityMultiplier * this.speedY
    });
    if (startSimulationY) {
      this._simulation.y.start();
    }
    return this.emit(Events.DidStartAnimation);
  };
  ...
  LayerDraggable.prototype._stopSimulation = function() {
    ...
    return this.emit(Events.DidEndAnimation);
  };
...
},{"./BaseClass":10,"./Defaults":18,"./EventBuffer":20,"./Events":23,"./Recognizers/PanRecognizer":36,"./Simulation":38,"./Underscore":43,"./Utils":44}],33:[function(require,module,exports){
...
},{"./BaseClass":10,"./Defaults":18,"./Events":23,"./Underscore":43}],34:[function(require,module,exports){
...
},{"./Context":16,"./Utils":44}],36:[function(require,module,exports){
var BaseClass, Events, Utils, _,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
exports.PanRecognizer = (function(superClass) {
  var STATE;

  extend(PanRecognizer, superClass);

  STATE = Utils.defineEnum(["POSSIBLE", "BEGAN", "CHANGED", "ENDED", "CANCELLED", "FAILED"], 0, 2);

  function PanRecognizer(eventBuffer, options) {
    ...
    this.thresholdX = this.options.lockDirectionOptions.thresholdX;
    this.thresholdY = this.options.lockDirectionOptions.thresholdY;
  }

  PanRecognizer.prototype.process = function() {
    var direction, offset, pan, panHalfX, panHalfY, panX, panY, ref, x, y;
    offset = (ref = this.eventBuffer.offset, x = ref.x, y = ref.y, ref);
    switch (this.state) {
      case STATE.POSSIBLE:
        panX = this.options.horizontal && Math.abs(x) > this.thresholdX;
        panY = this.options.vertical && Math.abs(y) > this.thresholdY;
        panHalfX = this.options.horizontal && Math.abs(x) > this.thresholdX / 2;
        panHalfY = this.options.vertical && Math.abs(y) > this.thresholdY / 2;
        ...
        if (panX || panY || pan) {
          ...
          this.emit(Events.DidStartPan, direction, offset);
          this.emit(Events.DidPan, offset);
          return this.state = STATE.BEGAN;
        }
        break;
      case STATE.BEGAN:
        return this.emit(Events.DidPan, offset);
    }
  };
...
},{"../BaseClass":10,"../Events":23,"../Underscore":43,"../Utils":44}],37:[function(require,module,exports){
...
},{"./BaseClass":10}],38:[function(require,module,exports){
...
},{"./BaseClass":10,"./Config":15,"./Defaults":18,"./Events":23,"./Simulators/FrictionSimulator":40,"./Simulators/MomentumBounceSimulator":41,"./Simulators/SpringSimulator":42,"./Underscore":43,"./Utils":44}],39:[function(require,module,exports){
...
},{"./BaseClass":10,"./Config":15,"./Underscore":43,"./Utils":44}],40:[function(require,module,exports){
...
},{"../Defaults":18,"../Integrator":29,"../Simulator":39,"../Utils":44}],41:[function(require,module,exports){
...
},{"../Defaults":18,"../Simulator":39,"../Utils":44,"./FrictionSimulator":40,"./SpringSimulator":42}],42:[function(require,module,exports){
var Defaults, Integrator, Simulator, Utils,
  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"../Defaults":18,"../Integrator":29,"../Simulator":39,"../Utils":44}],43:[function(require,module,exports){
var _;
...
},{"lodash":47,"underscore.string":70}],44:[function(require,module,exports){
...
Utils.inspectObjectType = function(item) {
  ...
  return objectType.slice(0, +(objectType.length - 2) + 1 || 9e9);
};

Utils.inspect = function(item, l, max) {
  var objectInfo, objectType;
  if (l == null) {
    l = 0;
  }
  if (max == null) {
...
},{"./Screen":37,"./Underscore":43}],45:[function(require,module,exports){
var Layer,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
},{"./Layer":30}],46:[function(require,module,exports){
'use strict';
...
},{"./decapitalize":56,"./trim":107}],49:[function(require,module,exports){
...
},{"./helper/makeString":65}],50:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/makeString":65}],51:[function(require,module,exports){
...
},{"./camelize":48,"./capitalize":49,"./helper/makeString":65}],53:[function(require,module,exports){
var trim = require('./trim');
...
},{"./trim":107}],54:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/makeString":65}],55:[function(require,module,exports){
var trim = require('./trim');
...
},{"./trim":107}],56:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/makeString":65}],58:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/makeString":65,"./helper/toPositive":67}],59:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/escapeChars":63,"./helper/makeString":65}],60:[function(require,module,exports){
...
},{"./makeString":65}],62:[function(require,module,exports){
...
},{"./makeString":65}],65:[function(require,module,exports){
/**
...
},{"./capitalize":49,"./trim":107,"./underscored":109}],69:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./camelize":48,"./capitalize":49,"./chars":50,"./chop":51,"./classify":52,"./clean":53,"./count":54,"./dasherize":55,"./decapitalize":56,"./dedent":57,"./endsWith":58,"./escapeHTML":59,"./exports":60,"./helper/escapeRegExp":64,"./humanize":68,"./include":69,"./insert":71,"./isBlank":72,"./join":73,"./levenshtein":74,"./lines":75,"./lpad":76,"./lrpad":77,"./ltrim":78,"./naturalCmp":79,"./numberFormat":80,"./pad":81,"./pred":82,"./prune":83,"./quote":84,"./repeat":85,"./replaceAll":86,"./reverse":87,"./rpad":88,"./rtrim":89,"./slugify":90,"./splice":91,"./sprintf":92,"./startsWith":93,"./strLeft":94,"./strLeftBack":95,"./strRight":96,"./strRightBack":97,"./stripTags":98,"./succ":99,"./surround":100,"./swapCase":101,"./titleize":102,"./toBoolean":103,"./toNumber":104,"./toSentence":105,"./toSentenceSerial":106,"./trim":107,"./truncate":108,"./underscored":109,"./unescapeHTML":110,"./unquote":111,"./vsprintf":112,"./words":113}],71:[function(require,module,exports){
...
},{"./splice":91}],72:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./pad":81}],77:[function(require,module,exports){
var pad = require('./pad');
...
},{"./pad":81}],78:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/defaultToWhiteSpace":62,"./helper/makeString":65}],79:[function(require,module,exports){
...
},{"./helper/makeString":65,"./helper/strRepeat":66}],82:[function(require,module,exports){
...
},{"./helper/adjacent":61}],83:[function(require,module,exports){
/**
...
},{"./helper/makeString":65,"./rtrim":89}],84:[function(require,module,exports){
...
},{"./surround":100}],85:[function(require,module,exports){
var makeString = require('./helper/makeString');
var strRepeat = require('./helper/strRepeat');
...
},{"./helper/makeString":65,"./helper/strRepeat":66}],86:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/makeString":65}],87:[function(require,module,exports){
...
},{"./chars":50}],88:[function(require,module,exports){
var pad = require('./pad');
...
},{"./pad":81}],89:[function(require,module,exports){
var makeString = require('./helper/makeString');
var defaultToWhiteSpace = require('./helper/defaultToWhiteSpace');
...
},{"./helper/defaultToWhiteSpace":62,"./helper/makeString":65}],90:[function(require,module,exports){
var makeString = require('./helper/makeString');
var defaultToWhiteSpace = require('./helper/defaultToWhiteSpace');
var trim = require('./trim');
...
},{"./dasherize":55,"./helper/defaultToWhiteSpace":62,"./helper/makeString":65,"./trim":107}],91:[function(require,module,exports){
var chars = require('./chars');
...
},{"./chars":50}],92:[function(require,module,exports){
...
},{"./helper/strRepeat":66}],93:[function(require,module,exports){
var makeString = require('./helper/makeString');
var toPositive = require('./helper/toPositive');
...
},{"./helper/makeString":65,"./helper/toPositive":67}],94:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/makeString":65}],95:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/adjacent":61}],100:[function(require,module,exports){
...
},{"./helper/makeString":65}],102:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./trim":107}],104:[function(require,module,exports){
var trim = require('./trim');
...
},{"./trim":107}],105:[function(require,module,exports){
var rtrim = require('./rtrim');
...
},{"./rtrim":89}],106:[function(require,module,exports){
...
},{"./toSentence":105}],107:[function(require,module,exports){
var makeString = require('./helper/makeString');
var defaultToWhiteSpace = require('./helper/defaultToWhiteSpace');
...
},{"./helper/defaultToWhiteSpace":62,"./helper/makeString":65}],108:[function(require,module,exports){
var makeString = require('./helper/makeString');
...
},{"./helper/makeString":65}],109:[function(require,module,exports){
var trim = require('./trim');
...
},{"./trim":107}],110:[function(require,module,exports){
var makeString = require('./helper/makeString');
var escapeChars = require('./helper/escapeChars');
...
},{"./helper/escapeChars":63,"./helper/makeString":65}],111:[function(require,module,exports){
...
},{"./sprintf":92}],113:[function(require,module,exports){
