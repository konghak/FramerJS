...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LayerDraggable = (function(superClass) {
	  ...
	  LayerDraggable.prototype._touchMove = function(event) {
	    ...
	    offset.x = offset.x * this.speedX * (1 / this._screenScale.x) * this.layer.scaleX * this.layer.scale;
	    offset.y = offset.y * this.speedY * (1 / this._screenScale.y) * this.layer.scaleY * this.layer.scale;
	  ...
	  LayerDraggable.prototype._startSimulation = function() {
	    ...
	    velocity = this.velocity;
	    velocityX = velocity.x * this.momentumVelocityMultiplier * this.speedX * (1 / this._screenScale.x) * this.layer.scaleX * this.layer.scale;
	    velocityY = velocity.y * this.momentumVelocityMultiplier * this.speedY * (1 / this._screenScale.y) * this.layer.scaleY * this.layer.scale;
